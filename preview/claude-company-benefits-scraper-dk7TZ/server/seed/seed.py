...
BEN_PRESETS = {
    "large": [
        {"key": "meal", "name": "식대 지원", "val": 180, "cat": "money", "badge": "est", "checked": True},
        {"key": "transport", "name": "교통비/주차비", "val": 120, "cat": "money", "badge": "est", "checked": True},
        {"key": "welfare", "name": "복지포인트/선택복지", "val": 200, "cat": "money", "badge": "est", "checked": True},
        {"key": "bonus", "name": "성과급/인센티브", "val": 300, "cat": "money", "badge": "est", "checked": False},
        {"key": "health", "name": "건강검진 (본인+가족)", "val": 100, "cat": "health", "badge": "est", "checked": True},
        {"key": "housing", "name": "사내대출 이자절감", "val": 200, "cat": "housing", "badge": "est", "checked": True},
        {"key": "child_edu", "name": "자녀 학자금", "val": 300, "cat": "family", "badge": "est", "checked": False},
        {"key": "event", "name": "경조사 지원", "val": 50, "cat": "money", "badge": "est", "checked": True},
    ],
    "mid": [
        {"key": "meal", "name": "식대 지원", "val": 150, "cat": "money", "badge": "est", "checked": True},
        {"key": "transport", "name": "교통비", "val": 60, "cat": "money", "badge": "est", "checked": True},
        {"key": "health", "name": "건강검진", "val": 50, "cat": "health", "badge": "est", "checked": True},
        {"key": "event", "name": "경조사 지원", "val": 30, "cat": "money", "badge": "est", "checked": True},
    ],
    "public": [
        {"key": "meal", "name": "식대 지원", "val": 180, "cat": "money", "badge": "est", "checked": True},
        {"key": "transport", "name": "교통비", "val": 120, "cat": "money", "badge": "est", "checked": True},
        {"key": "welfare", "name": "복지포인트/선택복지", "val": 250, "cat": "money", "badge": "est", "checked": True},
        {"key": "health", "name": "건강검진", "val": 80, "cat": "health", "badge": "est", "checked": True},
        {"key": "housing", "name": "사내대출 이자절감", "val": 250, "cat": "housing", "badge": "est", "checked": True},
        {"key": "child_edu", "name": "자녀 학자금", "val": 400, "cat": "family", "badge": "est", "checked": False},
        {"key": "edu", "name": "교육비/자기개발비", "val": 100, "cat": "edu", "badge": "est", "checked": True},
        {"key": "event", "name": "경조사 지원", "val": 50, "cat": "money", "badge": "est", "checked": True},
    ],
    "startup": [
        {"key": "meal", "name": "식대 지원", "val": 180, "cat": "money", "badge": "est", "checked": True},
        {"key": "stock", "name": "스톡옵션/RSU 기대값", "val": 500, "cat": "money", "badge": "est", "checked": False},
    ],
    "foreign": [
        {"key": "meal", "name": "식대 지원", "val": 180, "cat": "money", "badge": "est", "checked": True},
        {"key": "transport", "name": "교통비", "val": 100, "cat": "money", "badge": "est", "checked": True},
        {"key": "welfare", "name": "복지포인트", "val": 150, "cat": "money", "badge": "est", "checked": True},
        {"key": "bonus", "name": "성과급/인센티브", "val": 500, "cat": "money", "badge": "est", "checked": False},
        {"key": "health", "name": "건강검진", "val": 150, "cat": "health", "badge": "est", "checked": True},
        {"key": "edu", "name": "교육비 (도서, 세미나)", "val": 200, "cat": "edu", "badge": "est", "checked": True},
    ],
    "freelance": [],
}
...
COMPANIES = [
    {
        ...
        "benefits": [
            ...
            {"key": "commute_sup", "name": "출퇴근 셔틀 + 야근택시", "val": 120, "cat": "money", "badge": "est"},
            {"key": "event", "name": "경조사 지원", "val": 50, "cat": "money", "badge": "est"},
            ...
            {"key": "resort", "name": "프리미엄 숙소 할인", "val": 50, "cat": "housing", "badge": "est"},
            {"key": "lang", "name": "어학시험 응시료", "val": 15, "cat": "edu", "badge": "auto"},
            ...
            {"key": "discount", "name": "계열사 40% 할인", "val": 100, "cat": "life", "badge": "est", "note": "올리브영, CGV 등"},
            {"key": "tving", "name": "티빙 이용권", "val": 17, "cat": "life", "badge": "auto"},
            {"key": "travel", "name": "여행 지원", "val": 80, "cat": "life", "badge": "est"},
            {"key": "club", "name": "사내 동호회", "val": 30, "cat": "life", "badge": "est"},
    ...
    },
    {
        ...
        "benefits": [
            ...
            {"key": "cafe", "name": "사내 카페 무료", "val": 60, "cat": "health", "badge": "est"},
            {"key": "housing", "name": "주택자금 무이자 1억", "val": 350, "cat": "housing", "badge": "auto", "note": "시중 3.5% 기준 이자절감"},
            {"key": "edu", "name": "업무 교육비 100%", "val": 100, "cat": "edu", "badge": "auto", "note": "도서, 세미나 무제한"},
            {"key": "hardware", "name": "최고급 장비 제공", "val": 100, "cat": "edu", "badge": "est"},
            {"key": "flex", "name": "유연 출퇴근+원격근무", "val": 0, "cat": "leave", "badge": "auto", "qual": True, "qualText": "유연한 출퇴근 시간, 원격 근무 가능"},
            {"key": "unlimited_pto", "name": "자율 휴가 (승인 불필요)", "val": 0, "cat": "leave", "badge": "auto", "qual": True, "qualText": "별도 승인 없는 자율 휴가"},
            {"key": "refresh", "name": "리프레시 휴가 (3년마다 1개월)", "val": 0, "cat": "leave", "badge": "auto", "qual": True, "qualText": "근속 3년마다 1개월 유급 휴가"},
        ],
