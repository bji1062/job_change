...
// BEN_PRESETS 엔트리는 TBENEFIT_PRESET 컬럼과 1:1 매핑:
//   BENEFIT_CD / BENEFIT_NM / BENEFIT_AMT / CATEGORY_CD / BADGE_CD / NOTE_NM / checked(runtime)
const BEN_PRESETS={
  large:[{BENEFIT_CD:'meal',BENEFIT_NM:'식대 지원',BENEFIT_AMT:180,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'transport',BENEFIT_NM:'교통비/주차비',BENEFIT_AMT:120,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'welfare',BENEFIT_NM:'복지포인트/선택복지',BENEFIT_AMT:200,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'bonus',BENEFIT_NM:'성과급/인센티브',BENEFIT_AMT:300,CATEGORY_CD:'money',BADGE_CD:'est',checked:false,NOTE_NM:'성과에 따라 편차 큼'},{BENEFIT_CD:'health',BENEFIT_NM:'건강검진 (본인+가족)',BENEFIT_AMT:100,CATEGORY_CD:'health',BADGE_CD:'est',checked:true},{BENEFIT_CD:'housing',BENEFIT_NM:'사내대출 이자절감',BENEFIT_AMT:200,CATEGORY_CD:'housing',BADGE_CD:'est',checked:true},{BENEFIT_CD:'child_edu',BENEFIT_NM:'자녀 학자금',BENEFIT_AMT:300,CATEGORY_CD:'family',BADGE_CD:'est',checked:false,NOTE_NM:'자녀가 있는 경우'},{BENEFIT_CD:'event',BENEFIT_NM:'경조사 지원',BENEFIT_AMT:50,CATEGORY_CD:'money',BADGE_CD:'est',checked:true}],
  mid:[{BENEFIT_CD:'meal',BENEFIT_NM:'식대 지원',BENEFIT_AMT:150,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'transport',BENEFIT_NM:'교통비',BENEFIT_AMT:60,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'health',BENEFIT_NM:'건강검진',BENEFIT_AMT:50,CATEGORY_CD:'health',BADGE_CD:'est',checked:true},{BENEFIT_CD:'event',BENEFIT_NM:'경조사 지원',BENEFIT_AMT:30,CATEGORY_CD:'money',BADGE_CD:'est',checked:true}],
  public:[{BENEFIT_CD:'meal',BENEFIT_NM:'식대 지원',BENEFIT_AMT:180,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'transport',BENEFIT_NM:'교통비',BENEFIT_AMT:120,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'welfare',BENEFIT_NM:'복지포인트/선택복지',BENEFIT_AMT:250,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'health',BENEFIT_NM:'건강검진',BENEFIT_AMT:80,CATEGORY_CD:'health',BADGE_CD:'est',checked:true},{BENEFIT_CD:'housing',BENEFIT_NM:'사내대출 이자절감',BENEFIT_AMT:250,CATEGORY_CD:'housing',BADGE_CD:'est',checked:true},{BENEFIT_CD:'child_edu',BENEFIT_NM:'자녀 학자금',BENEFIT_AMT:400,CATEGORY_CD:'family',BADGE_CD:'est',checked:false,NOTE_NM:'자녀가 있는 경우'},{BENEFIT_CD:'edu',BENEFIT_NM:'교육비/자기개발비',BENEFIT_AMT:100,CATEGORY_CD:'edu',BADGE_CD:'est',checked:true},{BENEFIT_CD:'event',BENEFIT_NM:'경조사 지원',BENEFIT_AMT:50,CATEGORY_CD:'money',BADGE_CD:'est',checked:true}],
  startup:[{BENEFIT_CD:'meal',BENEFIT_NM:'식대 지원',BENEFIT_AMT:180,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'stock',BENEFIT_NM:'스톡옵션/RSU 기대값',BENEFIT_AMT:500,CATEGORY_CD:'money',BADGE_CD:'est',checked:false,NOTE_NM:'성공 시 기대값 — 불확실성 높음'}],
  foreign:[{BENEFIT_CD:'meal',BENEFIT_NM:'식대 지원',BENEFIT_AMT:180,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'transport',BENEFIT_NM:'교통비',BENEFIT_AMT:100,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'welfare',BENEFIT_NM:'복지포인트',BENEFIT_AMT:150,CATEGORY_CD:'money',BADGE_CD:'est',checked:true},{BENEFIT_CD:'bonus',BENEFIT_NM:'성과급/인센티브',BENEFIT_AMT:500,CATEGORY_CD:'money',BADGE_CD:'est',checked:false,NOTE_NM:'성과에 따라 편차 큼'},{BENEFIT_CD:'health',BENEFIT_NM:'건강검진',BENEFIT_AMT:150,CATEGORY_CD:'health',BADGE_CD:'est',checked:true},{BENEFIT_CD:'edu',BENEFIT_NM:'교육비 (도서, 세미나)',BENEFIT_AMT:200,CATEGORY_CD:'edu',BADGE_CD:'est',checked:true}],
  freelance:[],
};
...
// DB 엔트리는 TCOMPANY 컬럼과 1:1 매핑:
//   COMP_ENG_NM / COMP_NM / COMP_TP_CD / INDUSTRY_NM / LOGO_NM
//   ALIAS_NM_LIST (→ TCOMPANY_ALIAS 정규화 대상)
//   BENEFIT_LIST  (→ TCOMPANY_BENEFIT 정규화 대상, 내부 키는 BENEFIT_CD/NM/AMT/CATEGORY_CD/BADGE_CD/NOTE_NM/QUALITATIVE_YN/QUAL_TXT)
//   WORK_STYLE_JSON (JSON 페이로드 — 내부 서브키는 애플리케이션 계약)
const DB=[
  {COMP_ENG_NM:'cj',COMP_NM:'CJ그룹',ALIAS_NM_LIST:['CJ','cj','씨제이','CJ제일제당','CJ올리브영','CJ ENM'],COMP_TP_CD:'large',INDUSTRY_NM:'식품/유통/엔터',LOGO_NM:'CJ',
  BENEFIT_LIST:[{BENEFIT_CD:'meal',BENEFIT_NM:'구내식당 (아침·점심·저녁 100%)',BENEFIT_AMT:432,CATEGORY_CD:'money',BADGE_CD:'auto',NOTE_NM:'일 18,000원 × 240일'},{BENEFIT_CD:'cafe_point',BENEFIT_NM:'카페테리아 포인트',BENEFIT_AMT:200,CATEGORY_CD:'money',BADGE_CD:'auto'},{BENEFIT_CD:'commute_sup',BENEFIT_NM:'출퇴근 셔틀 + 야근택시',BENEFIT_AMT:120,CATEGORY_CD:'money',BADGE_CD:'est'},{BENEFIT_CD:'event',BENEFIT_NM:'경조사 지원',BENEFIT_AMT:50,CATEGORY_CD:'money',BADGE_CD:'est'},{BENEFIT_CD:'health',BENEFIT_NM:'건강검진 (본인+가족)',BENEFIT_AMT:100,CATEGORY_CD:'health',BADGE_CD:'auto'},{BENEFIT_CD:'medical',BENEFIT_NM:'의료비 지원',BENEFIT_AMT:100,CATEGORY_CD:'health',BADGE_CD:'est'},{BENEFIT_CD:'fitness',BENEFIT_NM:'피트니스 지원',BENEFIT_AMT:60,CATEGORY_CD:'health',BADGE_CD:'est'},{BENEFIT_CD:'housing',BENEFIT_NM:'주택대부 이자절감',BENEFIT_AMT:200,CATEGORY_CD:'housing',BADGE_CD:'est'},{BENEFIT_CD:'resort',BENEFIT_NM:'프리미엄 숙소 할인',BENEFIT_AMT:50,CATEGORY_CD:'housing',BADGE_CD:'est'},{BENEFIT_CD:'lang',BENEFIT_NM:'어학시험 응시료',BENEFIT_AMT:15,CATEGORY_CD:'edu',BADGE_CD:'auto'},{BENEFIT_CD:'child_edu',BENEFIT_NM:'자녀 학자금',BENEFIT_AMT:300,CATEGORY_CD:'family',BADGE_CD:'auto',NOTE_NM:'초·중·고·대학'},{BENEFIT_CD:'parenting',BENEFIT_NM:'임신·출산·육아 지원',BENEFIT_AMT:0,CATEGORY_CD:'family',BADGE_CD:'auto',QUALITATIVE_YN:true,QUAL_TXT:'키즈빌 운영, 배우자 출산휴가, 최대 2년 육아휴직'},{BENEFIT_CD:'wedding',BENEFIT_NM:'결혼 혜택',BENEFIT_AMT:0,CATEGORY_CD:'family',BADGE_CD:'auto',QUALITATIVE_YN:true,QUAL_TXT:'웨딩카 제공, 사내 인재원 웨딩홀 대관'},{BENEFIT_CD:'discount',BENEFIT_NM:'계열사 40% 할인',BENEFIT_AMT:100,CATEGORY_CD:'life',BADGE_CD:'est',NOTE_NM:'올리브영, CGV 등'},{BENEFIT_CD:'tving',BENEFIT_NM:'티빙 이용권',BENEFIT_AMT:17,CATEGORY_CD:'life',BADGE_CD:'auto'},{BENEFIT_CD:'travel',BENEFIT_NM:'여행 지원',BENEFIT_AMT:80,CATEGORY_CD:'life',BADGE_CD:'est'},{BENEFIT_CD:'club',BENEFIT_NM:'사내 동호회',BENEFIT_AMT:30,CATEGORY_CD:'life',BADGE_CD:'est'},{BENEFIT_CD:'creative_leave',BENEFIT_NM:'창의휴가 (근속 시 2주 유급)',BENEFIT_AMT:0,CATEGORY_CD:'leave',BADGE_CD:'auto',QUALITATIVE_YN:true,QUAL_TXT:'3·5·7·10년 근속 시 2주간 유급 휴가'}],WORK_STYLE_JSON:{remote:false,flex:false,unlimitedPTO:false,refreshLeave:'3·5·7·10년 근속 시 2주 유급',overtime:'일반적 대기업 수준'}},
  {COMP_ENG_NM:'toss',COMP_NM:'토스 (비바리퍼블리카)',ALIAS_NM_LIST:['토스','toss','Toss','비바리퍼블리카','비바'],COMP_TP_CD:'startup',INDUSTRY_NM:'핀테크',LOGO_NM:'T',
  BENEFIT_LIST:[{BENEFIT_CD:'meal',BENEFIT_NM:'법인카드 식사 (점심+저녁 100%)',BENEFIT_AMT:432,CATEGORY_CD:'money',BADGE_CD:'auto',NOTE_NM:'일 18,000원 × 240일'},{BENEFIT_CD:'fitness_comm',BENEFIT_NM:'체력단련비+통신비 (매월)',BENEFIT_AMT:120,CATEGORY_CD:'money',BADGE_CD:'auto'},{BENEFIT_CD:'insurance',BENEFIT_NM:'직장 단체보험 (가족 포함)',BENEFIT_AMT:150,CATEGORY_CD:'health',BADGE_CD:'auto'},{BENEFIT_CD:'salon',BENEFIT_NM:'사내 헤어살롱',BENEFIT_AMT:30,CATEGORY_CD:'health',BADGE_CD:'est'},{BENEFIT_CD:'cafe',BENEFIT_NM:'사내 카페 무료',BENEFIT_AMT:60,CATEGORY_CD:'health',BADGE_CD:'est'},{BENEFIT_CD:'housing',BENEFIT_NM:'주택자금 무이자 1억',BENEFIT_AMT:350,CATEGORY_CD:'housing',BADGE_CD:'auto',NOTE_NM:'시중 3.5% 기준 이자절감'},{BENEFIT_CD:'edu',BENEFIT_NM:'업무 교육비 100%',BENEFIT_AMT:100,CATEGORY_CD:'edu',BADGE_CD:'auto',NOTE_NM:'도서, 세미나 무제한'},{BENEFIT_CD:'hardware',BENEFIT_NM:'최고급 장비 제공',BENEFIT_AMT:100,CATEGORY_CD:'edu',BADGE_CD:'est'},{BENEFIT_CD:'flex',BENEFIT_NM:'유연 출퇴근+원격근무',BENEFIT_AMT:0,CATEGORY_CD:'leave',BADGE_CD:'auto',QUALITATIVE_YN:true,QUAL_TXT:'유연한 출퇴근 시간, 원격 근무 가능'},{BENEFIT_CD:'unlimited_pto',BENEFIT_NM:'자율 휴가 (승인 불필요)',BENEFIT_AMT:0,CATEGORY_CD:'leave',BADGE_CD:'auto',QUALITATIVE_YN:true,QUAL_TXT:'별도 승인 없는 자율 휴가'},{BENEFIT_CD:'refresh',BENEFIT_NM:'리프레시 휴가 (3년마다 1개월)',BENEFIT_AMT:0,CATEGORY_CD:'leave',BADGE_CD:'auto',QUALITATIVE_YN:true,QUAL_TXT:'근속 3년마다 1개월 유급 휴가'}],WORK_STYLE_JSON:{remote:true,flex:true,unlimitedPTO:true,refreshLeave:'3년마다 1개월 유급',overtime:'자율 (성과 중심)'}}
];
