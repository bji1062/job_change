...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "삼성물산" --url "https://www.samsungcnt.com/careers/main.do" --raw-only
...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "한화오션" --url "https://recruit-hanwhaocean.com/ko/intro" --raw-only
...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "LG화학" --url "https://www.lgchem.com/career/index" --raw-only
...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "메리츠금융지주" --url "https://recruit.meritzfire.com/" --raw-only
...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "에코프로비엠" --url "https://ecoprobm.co.kr/sub030301" --raw-only
server/tools/.venv/bin/python server/tools/scrape_benefits.py "하이브" --url "https://careers.hybecorp.com/ko/home" --raw-only
server/tools/.venv/bin/python server/tools/scrape_benefits.py "LS ELECTRIC" --url "https://lselectric.recruiter.co.kr/career/home" --raw-only
server/tools/.venv/bin/python server/tools/scrape_benefits.py "현대글로비스" --url "https://glovis.recruiter.co.kr/career/home" --raw-only
server/tools/.venv/bin/python server/tools/scrape_benefits.py "삼성SDS" --url "https://www.samsungsds.com/kr/careers/process/apply.html" --raw-only
...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "크래프톤" --url "https://www.krafton.com/en/careers/life/" --raw-only
...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "DB손해보험" --url "https://dbgroup.recruiter.co.kr/career/home" --raw-only
...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "한국금융지주" --url "https://www.koreaholdings.com/kr/recruitment/talent" --raw-only
server/tools/.venv/bin/python server/tools/scrape_benefits.py "유한양행" --url "https://yuhan.recruiter.co.kr/career/home" --raw-only
...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "한국타이어앤테크놀로지" --url "https://hankooktire.recruiter.co.kr/career/home" --raw-only
server/tools/.venv/bin/python server/tools/scrape_benefits.py "아모레퍼시픽" --url "https://careers.apgroup.com/" --raw-only
...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "LS" --url "https://www.lsholdings.com/ko/careers/recruitment-guide" --raw-only
server/tools/.venv/bin/python server/tools/scrape_benefits.py "LG유플러스" --url "https://careers.lg.com/" --raw-only
server/tools/.venv/bin/python server/tools/scrape_benefits.py "코웨이" --url "https://company.coway.com/recruit/personnel" --raw-only
...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "한미약품" --url "https://hanmi.recruiter.co.kr/career/home" --raw-only
...
server/tools/.venv/bin/python server/tools/scrape_benefits.py "롯데케미칼" --url "https://www.lottechem.com/ko/recruit/employment/list.do" --raw-only
