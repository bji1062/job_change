...
BEN_PRESETS = {
    "large": [
        ...
        {"key": "health", "name": "건강검진 (본인+가족)", "val": 100, "cat": "wellness", "badge": "est", "checked": True},
        {"key": "housing", "name": "사내대출 이자절감", "val": 200, "cat": "financial", "badge": "est", "checked": True},
    ...
    "public": [
        ...
        {"key": "housing", "name": "사내대출 이자절감", "val": 250, "cat": "financial", "badge": "est", "checked": True},
    ...
    "foreign": [
        ...
        {"key": "health", "name": "건강검진", "val": 150, "cat": "wellness", "badge": "est", "checked": True},
...
COMPANIES = [
    {
        ...
        "benefits": [
            ...
            {"key": "health", "name": "건강검진 (본인+가족)", "val": 100, "cat": "wellness", "badge": "auto"},
            {"key": "medical", "name": "의료비 지원", "val": 100, "cat": "wellness", "badge": "est"},
            {"key": "fitness", "name": "피트니스 지원", "val": 60, "cat": "wellness", "badge": "est"},
            {"key": "housing", "name": "주택대부 이자절감", "val": 200, "cat": "financial", "badge": "est"},
            {"key": "resort", "name": "프리미엄 숙소 할인", "val": 50, "cat": "life", "badge": "est"},
            ...
            {"key": "discount", "name": "계열사 40% 할인", "val": 100, "cat": "financial", "badge": "est", "note": "올리브영, CGV 등"},
            ...
            {"key": "creative_leave", "name": "창의휴가 (근속 시 2주 유급)", "val": 0, "cat": "time", "badge": "auto", "qual": True, "qualText": "3·5·7·10년 근속 시 2주간 유급 휴가"},
        ],
    ...
    },
    {
        ...
        "benefits": [
            ...
            {"key": "housing", "name": "주택자금 무이자 1억", "val": 350, "cat": "financial", "badge": "auto", "note": "시중 3.5% 기준 이자절감"},
            ...
            {"key": "flex", "name": "유연 출퇴근+원격근무", "val": 0, "cat": "time", "badge": "auto", "qual": True, "qualText": "유연한 출퇴근 시간, 원격 근무 가능"},
            {"key": "unlimited_pto", "name": "자율 휴가 (승인 불필요)", "val": 0, "cat": "time", "badge": "auto", "qual": True, "qualText": "별도 승인 없는 자율 휴가"},
