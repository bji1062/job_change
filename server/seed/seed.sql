...
('large', 'meal', '식대 지원', 180, 'work_env', 'est', TRUE, 0),
('large', 'transport', '교통비/주차비', 120, 'work_env', 'est', TRUE, 1),
('large', 'welfare', '복지포인트/선택복지', 200, 'financial', 'est', TRUE, 2),
('large', 'bonus', '성과급/인센티브', 300, 'financial', 'est', FALSE, 3),
('large', 'health', '건강검진 (본인+가족)', 100, 'wellness', 'est', TRUE, 4),
('large', 'housing', '사내대출 이자절감', 200, 'financial', 'est', TRUE, 5),
('large', 'child_edu', '자녀 학자금', 300, 'family', 'est', FALSE, 6),
('large', 'event', '경조사 지원', 50, 'financial', 'est', TRUE, 7),
('mid', 'meal', '식대 지원', 150, 'work_env', 'est', TRUE, 0),
('mid', 'transport', '교통비', 60, 'work_env', 'est', TRUE, 1),
('mid', 'health', '건강검진', 50, 'wellness', 'est', TRUE, 2),
('mid', 'event', '경조사 지원', 30, 'financial', 'est', TRUE, 3),
('public', 'meal', '식대 지원', 180, 'work_env', 'est', TRUE, 0),
('public', 'transport', '교통비', 120, 'work_env', 'est', TRUE, 1),
('public', 'welfare', '복지포인트/선택복지', 250, 'financial', 'est', TRUE, 2),
('public', 'health', '건강검진', 80, 'wellness', 'est', TRUE, 3),
('public', 'housing', '사내대출 이자절감', 250, 'financial', 'est', TRUE, 4),
('public', 'child_edu', '자녀 학자금', 400, 'family', 'est', FALSE, 5),
('public', 'edu', '교육비/자기개발비', 100, 'growth', 'est', TRUE, 6),
('public', 'event', '경조사 지원', 50, 'financial', 'est', TRUE, 7),
('startup', 'meal', '식대 지원', 180, 'work_env', 'est', TRUE, 0),
('startup', 'stock', '스톡옵션/RSU 기대값', 500, 'financial', 'est', FALSE, 1),
('foreign', 'meal', '식대 지원', 180, 'work_env', 'est', TRUE, 0),
('foreign', 'transport', '교통비', 100, 'work_env', 'est', TRUE, 1),
('foreign', 'welfare', '복지포인트', 150, 'financial', 'est', TRUE, 2),
('foreign', 'bonus', '성과급/인센티브', 500, 'financial', 'est', FALSE, 3),
('foreign', 'health', '건강검진', 150, 'wellness', 'est', TRUE, 4),
('foreign', 'edu', '교육비 (도서, 세미나)', 200, 'growth', 'est', TRUE, 5);
...
('cj', 'meal', '구내식당 (아침·점심·저녁 100%)', 432, 'work_env', 'auto', '일 18,000원 × 240일', FALSE, NULL, 0),
('cj', 'cafe_point', '카페테리아 포인트', 200, 'financial', 'auto', NULL, FALSE, NULL, 1),
('cj', 'commute_sup', '출퇴근 셔틀 + 야근택시', 120, 'work_env', 'est', NULL, FALSE, NULL, 2),
('cj', 'event', '경조사 지원', 50, 'financial', 'est', NULL, FALSE, NULL, 3),
('cj', 'health', '건강검진 (본인+가족)', 100, 'wellness', 'auto', NULL, FALSE, NULL, 4),
('cj', 'medical', '의료비 지원', 100, 'wellness', 'est', NULL, FALSE, NULL, 5),
('cj', 'fitness', '피트니스 지원', 60, 'wellness', 'est', NULL, FALSE, NULL, 6),
('cj', 'housing', '주택대부 이자절감', 200, 'financial', 'est', NULL, FALSE, NULL, 7),
('cj', 'resort', '프리미엄 숙소 할인', 50, 'life', 'est', NULL, FALSE, NULL, 8),
('cj', 'lang', '어학시험 응시료', 15, 'growth', 'auto', NULL, FALSE, NULL, 9),
...
('cj', 'creative_leave', '창의휴가 (근속 시 2주 유급)', 0, 'time', 'auto', NULL, TRUE, '3·5·7·10년 근속 시 2주간 유급 휴가', 17),
('toss', 'meal', '법인카드 식사 (점심+저녁 100%)', 432, 'work_env', 'auto', '일 18,000원 × 240일', FALSE, NULL, 0),
('toss', 'fitness_comm', '체력단련비+통신비 (매월)', 120, 'financial', 'auto', NULL, FALSE, NULL, 1),
('toss', 'insurance', '직장 단체보험 (가족 포함)', 150, 'wellness', 'auto', NULL, FALSE, NULL, 2),
('toss', 'salon', '사내 헤어살롱', 30, 'work_env', 'est', NULL, FALSE, NULL, 3),
('toss', 'cafe', '사내 카페 무료', 60, 'work_env', 'est', NULL, FALSE, NULL, 4),
('toss', 'housing', '주택자금 무이자 1억', 350, 'financial', 'auto', '시중 3.5% 기준 이자절감', FALSE, NULL, 5),
('toss', 'edu', '업무 교육비 100%', 100, 'growth', 'auto', '도서, 세미나 무제한', FALSE, NULL, 6),
('toss', 'hardware', '최고급 장비 제공', 100, 'work_env', 'est', NULL, FALSE, NULL, 7),
('toss', 'flex', '유연 출퇴근+원격근무', 0, 'time', 'auto', NULL, TRUE, '유연한 출퇴근 시간, 원격 근무 가능', 8),
('toss', 'unlimited_pto', '자율 휴가 (승인 불필요)', 0, 'time', 'auto', NULL, TRUE, '별도 승인 없는 자율 휴가', 9),
('toss', 'refresh', '리프레시 휴가 (3년마다 1개월)', 0, 'time', 'auto', NULL, TRUE, '근속 3년마다 1개월 유급 휴가', 10);
